...
if __name__ == "__main__":
  path = "/home/caio/Documents/PhD/VANET/cologne-data/graphs_with_metrics/10000.gt.xz"
  gt = gt.load_graph(path)
  gts_to_graph_tuple([gt], vps={"label": "string", "pos": "array", "speed": "scalar", "dgc": "scalar", "cnw": "scalar"},
